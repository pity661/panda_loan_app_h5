        ...
        <div class="profile-table">
            <div class="profile-tab"  @click="goHelp">
                <div class="profile-icon">
                    <img src="~@/assets/didihelpicon.png" alt="">
                </div>
        ...
        <div class="profile-tables">
            <div class="profile-tabs"  @click="goSetting">
                <div class="profile-icons">
                    <img src="~@/assets/didiiconsetting.png" alt="">
                </div>
            ...
            <div class="profile-tabs"  @click="goabouts" >
                <div class="profile-icons">
                    <img src="~@/assets/didiabout.png" alt="">
                </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            ...
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/didihelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/xyaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/didiaboutUs"
        }
    },
  mounted(){
...
.profile-head{
    ...
    width: 100%;
    height:auto;
    background:url('~@/assets/didibackground.png');
    overflow: hidden;
    .profile-title{
        width: 100%;
        height: 88*$rem;
