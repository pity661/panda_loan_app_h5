    ...
    <div class="profile-tables">
        <div class="profile-tabs">
            <div class="profile-icons">
                <img src="~@/assets/sdsetting.png" alt="">
            </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            ...
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/sdhelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/mcaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/sdaboutus"
        }
    },
  mounted(){
...
.profile-head{
    ...
    .profile-img{
        ...
        width: 100%;
        height: 232*$rem;
        background: url("~@/assets/sdbacground.png") no-repeat;
