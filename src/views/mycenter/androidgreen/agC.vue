    ...
    <div class="profile-table">
        <div class="profile-tab" @click="goHelp">
            <div class="profile-icon">
                <img src="~@/assets/name1help.png" alt="">
            </div>
    ...
    <div class="profile-tables">
        <div class="profile-tabs">
            <div class="profile-icons">
                <img src="~@/assets/name1setting.png" alt="">
            </div>
        ...
        <div class="profile-tabs" @click="goabouts">
            <div class="profile-icons">
                <img src="~@/assets/name1icon.png" alt="">
            </div>
...
export default {
    ...
    methods: {
        ...
        goSetting(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/setting"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/setting"
        },
        goHelp(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/mchelpCenter"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/androidgreenhelpCenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/mcaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/androidgreenabout"
        }
    },
  mounted(){
...
.profile-head{
    ...
    .profile-img{
        ...
        width: 100%;
        height: 232*$rem;
        background: url("~@/assets/androidgreen.png") no-repeat;
