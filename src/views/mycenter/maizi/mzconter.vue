    ...
    <div id="app">
        ...
        <div class="profile-tables">
            ...
            <div class="profile-tabs"  @click="goSetting">
                <div class="profile-icons">
                    <img src="~@/assets/mzsetting.png" alt="">
                </div>
                <div class="profile-tabmenu">
                    <div class="profileicon-texs">
                        设置
            ...
            <div class="profile-tabs"  @click="goabouts" >
                <div class="profile-icons">
                    <img src="~@/assets/mzabout.png" alt="">
                </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/mzhelpcenter"
        },
        goabouts(){
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/mzabouts"
        }
    },
  mounted(){
