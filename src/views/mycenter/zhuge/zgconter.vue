...
export default {
    ...
    methods: {
        ...
        goHelp(){
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/zghelpcenter"
        },
        goabouts(){
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/zgabouts"
        }
