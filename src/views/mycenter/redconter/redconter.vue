    ...
    <div class="profile-table">
        <div class="profile-tab" @click="goHelp">
            <div class="profile-icon">
                <img src="~@/assets/redhelp.png" alt="">
            </div>
    ...
    <div class="profile-tables">
        <div class="profile-tabs">
            <div class="profile-icons">
                <img src="~@/assets/redsetting.png" alt="">
            </div>
        ...
        <div class="profile-tabs" @click="goabouts">
            <div class="profile-icons">
                <img src="~@/assets/redicon.png" alt="">
            </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            ...
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/redhelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/mcaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/redaboutus"
        }
    },
  mounted(){
...
.profile-head{
    ...
    .profile-img{
        ...
        width: 100%;
        height: 232*$rem;
        background: url("~@/assets/redbackground.png") no-repeat;
