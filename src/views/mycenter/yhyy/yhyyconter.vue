        ...
        <div class="profile-table">
            <div class="profile-tab"  @click="goHelp">
                <div class="profile-icon">
                    <img src="~@/assets/yhyyhelp.png" alt="">
                </div>
        ...
        <div class="profile-tables">
            <div class="profile-tabs"  @click="goSetting">
                <div class="profile-icons">
                    <img src="~@/assets/yhyysetting.png" alt="">
                </div>
            ...
            <div class="profile-tabs"  @click="goabouts" >
                <div class="profile-icons">
                    <img src="~@/assets/yhyyabout.png" alt="">
                </div>
...
export default {
    ...
    methods: {
        ...
        goSetting(){
            ...
            window.location.href = "https://www.pinganzhiyuan.com/panda_loan_app_web/setting"
        },
        goHelp(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/xyhelpcenter"
            window.location.href = "https://www.pinganzhiyuan.com/panda_loan_app_web/yhyyhelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/xyaboutus"
            window.location.href = "https://www.pinganzhiyuan.com/panda_loan_app_web/yhyyaboutUs"
        }
    },
  mounted(){
