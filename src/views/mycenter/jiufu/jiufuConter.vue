    ...
    <div class="profile-table">
        <div class="profile-tab" @click="goHelp">
            <div class="profile-icon">
                <img src="~@/assets/jiufuhelp.png" alt="">
            </div>
    ...
    <div class="profile-tables">
        <div class="profile-tabs" @click="goSetting">
            <div class="profile-icons">
                <img src="~@/assets/jiufuSetting.png" alt="">
            </div>
        ...
        <div class="profile-tabs"  @click="goabouts">
            <div class="profile-icons">
                <img src="~@/assets/jiufuAbouts.png" alt="">
            </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/jiufuhelpcenter"
        },
        goabouts(){
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/jiufuwalletabouts"
        }
...
.profile-head{
    ...
    .profile-backimg{
        ...
        height: auto;
        overflow: hidden;
        background:url('~@/assets/jiufuback.png');
            .profile-img{
                float: left;
                width: auto;
                height: 120*$rem;
