...
export default {
    ...
    methods: {
        ...
        goHelp(){
            ...
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/mchelpCenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/mcaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/mcaboutus"
        }
    },
  mounted(){
