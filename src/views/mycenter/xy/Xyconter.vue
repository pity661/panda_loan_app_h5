...
export default {
    ...
    methods: {
        ...
        goHelp(){
            ...
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/xyhelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/xyaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/xyaboutus"
        }
    },
  mounted(){
