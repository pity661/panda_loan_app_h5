...
export default {
    ...
    methods: {
        ...
        goSetting(){
            //window.location.href="http://119.23.236.252:83/panda_loan_app_web/setting"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/setting"
        },
        goHelp(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/axhelpcenter"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/axhelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/axhboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/axhboutus"
        }
    },
  mounted(){
