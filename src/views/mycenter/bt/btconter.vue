        ...
        <div class="profile-table">
            <div class="profile-tab"  @click="goHelp">
                <div class="profile-icon">
                    <img src="~@/assets/accounthelpicon.png" alt="">
                </div>
        ...
        <div class="profile-tables">
            <div class="profile-tabs"  @click="goSetting">
                <div class="profile-icons">
                    <img src="~@/assets/accountsetting.png" alt="">
                </div>
            ...
            <div class="profile-tabs"  @click="goabouts" >
                <div class="profile-icons">
                    <img src="~@/assets/accountabout.png" alt="">
                </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            // window.location.href="http://119.23.12.36:84/panda_loan_app_web/bthelpcenter"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/bthelpcenter"
        },
        goabouts(){
            // window.location.href="http://119.23.12.36:84/panda_loan_app_web/accountabouts"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/accountabouts"
        }
    },
  mounted(){
