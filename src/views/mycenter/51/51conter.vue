        ...
        <div class="profile-tables">
            <div class="profile-tabs" @click="goHelp">
                <div class="profile-icons">
                    <img src="~@/assets/helpiconred.png" alt="">
                </div>
...
export default {
    ...
    methods: {
        ...
        goHelp(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/xyhelpcenter"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/fiveoneHelpCenter"
        },
        goabouts(){
            // window.location.href="http://119.23.236.252:83/panda_loan_mobile_web/xyaboutus"
            window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/fiveoneAbouts"
        }
    },
  mounted(){
