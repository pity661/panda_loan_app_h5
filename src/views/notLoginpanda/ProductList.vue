                    ...
                    <div class="bannerList">
                        <mt-swipe :auto="3000">
                            <mt-swipe-item v-for="(item,index) in bannerList" :key="index">
                                <img :src="item.bigImgUrl" alt="" @click="bannerClick(index)">
                            </mt-swipe-item>
                            <!-- <mt-swipe-item>
                                <img src="http://47.104.72.197:81/testguanggao.png" alt="">
                            </mt-swipe-item> -->
                        </mt-swipe>
                    </div>
                     <!--栏目-->
...
export default {
  ...
  methods: {
    ...
    toClassification(index) {  //跳转商品分类详情
       window.location.href = "http://www.pinganzhiyuan.com/panda_loan_app_web/appClassification?title="+this.productListArrar[index].title +"&id=" +this.productListArrar[index].id + '&uid=' + this.Uid
    },
    ...
    bannerClick(index){ //banner点击跳转
        this.iframeUri = this.bannerList[index].url;
