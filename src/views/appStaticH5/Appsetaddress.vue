<template>
    <div class="tianjiaaddress">
        ...
        <div class="setAddress" @click="saveAddress" ref="maincolor">
            保存地址
        </div>
            ...
            saveAddress(){  //跳转到添加页面`
                    ...
                    if(this.name==""){
                        ...
                        if(localStorage.getItem('addressData')==null){
                            ...
                            // this.$router.push({ path: '/appaddress'})
                            window.location.href = "https://static.pinganzhiyuan.com/panda_loan_app_web/appaddress"
                        }else{
