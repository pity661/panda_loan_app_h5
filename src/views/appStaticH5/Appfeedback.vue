<template>
	<div id="app">
        ...
        <!-- 机主消息 -->
        <div class="myInfo" v-show="news" ref=""> 
            <div class="myImg">
                <img src="~@/assets/boy.png" alt="">
            </div>
            <div class="meback"  ref="meback">
                {{myData}}
            </div>
        </div>

        <!-- 反馈消息 -->
        <div class="outherInfo" v-show="outher">
            <div class="outherImg">
                <img src="~@/assets/girl.png" alt="">
            </div>
            <div class="myInfodata"  ref="fankui">
        ...
        <div class="feedback-foot" v-if="submitIf"> 
            ...
            <div class="feedback-button" @click="submit" ref="maincolor">
                发送
            </div>
        </div>
	</div>
...
export default {
  ...
  methods: {
        ...
        this.$ajax.post(url,qs.stringify(params)).then( res => {
            ...
            this.$refs.meback.style.background = '#'+jsonParameter.color
            this.$refs.fankui.style.background = '#'+jsonParameter.color
